...
function love.draw()
    ...
    love.graphics.print(tostring("distance: "..tostring(player:distanceFrom(player.characters[player.currentChar].x,player.characters[player.currentChar].y,mouse.mouseOverTile[1],mouse.mouseOverTile[2]))), 200, 560)
